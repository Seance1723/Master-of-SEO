...
export const assetOptimizationRules: PerformanceRule[] = [
  {
...
export function checkAssetOptimization(input: PerformanceAuditInput): { issues: PerformanceAuditIssue[]; passedChecks: string[] } {
