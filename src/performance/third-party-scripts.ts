...
export const thirdPartyScriptRules: PerformanceRule[] = [
  {
...
export function checkThirdPartyScripts(input: PerformanceAuditInput): { issues: PerformanceAuditIssue[]; passedChecks: string[] } {
