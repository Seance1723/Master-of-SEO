...
export const cssPerformanceRules: PerformanceRule[] = [
  {
...
export function checkCssPerformance(input: PerformanceAuditInput): { issues: PerformanceAuditIssue[]; passedChecks: string[] } {
