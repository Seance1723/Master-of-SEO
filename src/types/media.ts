...
export interface MediaAuditInput {
  url?: string;
  html?: string;
  page?: { url?: string; pageType?: MediaPageType; title?: string; primaryKeyword?: string; visibleContent?: string };
  images?: MediaImageInput[];
  videos?: MediaVideoInput[];
  openGraph?: { ogImage?: string; ogImageAlt?: string; twitterImage?: string; twitterImageAlt?: string };
  schema?: { jsonLd?: JsonObject[] };
  assets?: Array<{ url: string; type: "image" | "video" | "font" | "script" | "stylesheet" | "unknown"; sizeKb?: number; format?: string }>;
  mode: MediaMode;
}
