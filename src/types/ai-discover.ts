...
export interface AISearchAuditInput {
  ...
  content?: {
    summary?: string;
    sections?: Array<{ heading?: string; text?: string; type?: "definition" | "steps" | "comparison" | "faq" | "table" | "list" | "example" | "proof" | "case_study" | "unknown" }>;
    faqs?: Array<{ question: string; answer: string }>;
    tables?: Array<{ caption?: string; headers?: string[]; rows?: unknown[][] }>;
    answerBlocks?: Array<{ question?: string; answer: string; position?: "above_fold" | "body" | "below_fold" | "unknown" }>;
    sources?: Array<{ title?: string; url?: string; type?: "official" | "research" | "news" | "blog" | "forum" | "unknown" }>;
    originalInsights?: string[];
    examples?: string[];
    caseStudies?: string[];
  };
  entities?: Array<{ name: string; type: "organization" | "person" | "product" | "service" | "software" | "location" | "topic" | "brand" | "unknown"; description?: string; sameAs?: string[] }>;
  queries?: Array<{ query: string; intent?: QueryIntent }>;
  schema?: { jsonLd?: JsonObject[] };
...
export interface DiscoverSEOAuditInput {
  ...
  images?: Array<{ src: string; width?: number; height?: number; alt?: string; position?: "hero" | "body" | "thumbnail" | "unknown" }>;
  openGraph?: {
    ogTitle?: string;
