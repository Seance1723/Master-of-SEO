...
export const crawlabilityRules: TechnicalRule[] = [
  {
...
export function checkCrawlability(input: TechnicalAuditInput): { issues: TechnicalAuditIssue[]; passedChecks: string[] } {
