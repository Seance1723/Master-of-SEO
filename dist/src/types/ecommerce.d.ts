...
export interface EcommerceAuditInput {
    ...
    internalLinks?: Array<{
        ...
        to: string;
        anchorText?: string;
        linkType?: "navigation" | "breadcrumb" | "contextual" | "related_product" | "related_category" | "footer" | "unknown";
    }>;
    mode: EcommerceMode;
}
