...
export interface SEOStrategyInput {
    ...
    websiteAudit?: {
        ...
        quickWins?: unknown[];
        strategicOpportunities?: unknown[];
        categoryScores?: Record<string, unknown>;
    };
    keywordResearch?: {
        clusters?: Record<string, unknown>[];
        keywordMap?: Record<string, unknown>[];
        cannibalizationRisks?: Record<string, unknown>[];
        opportunities?: Record<string, unknown>[];
    };
    contentPlan?: {
        pillarPages?: Record<string, unknown>[];
        supportingPages?: Record<string, unknown>[];
        contentGaps?: Record<string, unknown>[];
        refreshPlan?: Record<string, unknown>[];
        pruningPlan?: Record<string, unknown>[];
        contentCalendar?: Record<string, unknown>[];
    };
    competitorAnalysis?: {
        keywordGaps?: Record<string, unknown>[];
        contentGaps?: Record<string, unknown>[];
        backlinkGaps?: Record<string, unknown>[];
        serpFeatureOpportunities?: Record<string, unknown>[];
        opportunities?: Record<string, unknown>[];
    };
    resources?: {
        monthlyContentCapacity?: number;
        developerHoursPerMonth?: number;
        seoHoursPerMonth?: number;
        designerHoursPerMonth?: number;
        budgetLevel?: "low" | "medium" | "high" | "unknown";
        teamSize?: number;
    };
    constraints?: {
        timeline?: "30_days" | "60_days" | "90_days" | "6_months" | "12_months" | "unknown";
        priority?: "traffic" | "leads" | "sales" | "technical_cleanup" | "content_growth" | "authority" | "migration" | "launch" | "balanced";
    ...
    launch?: {
        ...
        hasNoindexRemoved?: boolean;
        templatesTested?: boolean;
    };
    migration?: {
        isMigration?: boolean;
        migrationType?: "domain" | "cms" | "redesign" | "url_structure" | "http_to_https" | "platform" | "unknown";
        oldUrls?: string[];
        newUrls?: string[];
        redirectMap?: Array<{
            oldUrl: string;
            newUrl?: string;
            status?: "planned" | "implemented" | "missing" | "unknown";
        }>;
        highValuePages?: string[];
        backedUpMetadata?: boolean;
        backedUpContent?: boolean;
        testedRedirects?: boolean;
        submittedNewSitemap?: boolean;
    };
    mode?: StrategyMode;
}
